...
-- Description: Creates the basic tables for assets and EXIF data
...
DROP INDEX IF EXISTS idx_exif_make_model;
DROP INDEX IF EXISTS idx_exif_datetime;
DROP TABLE IF EXISTS asset_exif;
